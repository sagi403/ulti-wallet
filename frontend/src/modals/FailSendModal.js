...
const FailSendModal = ({ show, onHide, coinId }) => {
  return (
    <Modal
      show={show}
      onHide={onHide}
    ...
    >
      ...
      <Modal.Body className="coin_exchange_from_table">
        <div className="successful_swap_body">
          <p>We couldn't complete your transaction, please try again later.</p>
        </div>
      </Modal.Body>
      <Modal.Footer className="coin_exchange_from_table d-flex justify-content-evenly">
        ...
        <Link to={`/app/transfer/${coinId}/send`}>
